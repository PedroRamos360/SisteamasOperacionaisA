...
; le um numero do usuario, ateh que seja valido
lechute  espaco 1
lechute1 cargi str2
         chama escstr
lechute2
...
; ve se chute em A eh bom, escreve mensagem, retorna 1 se for
vechute  espaco 1
         armm chute
         cargi LIMPA
         chama escch
...
li_f
        ...
        ; foi lido um caractere a mais, infelizmente não tem como devolve-lo
...
ei_neg
        ...
        chama escch
ei_pos
        ; faz ei_mul ser a maior potencia de 10 <= ei_num
        ; ei_mul = 1
        cargi 1
        armm ei_mul
ei_1
